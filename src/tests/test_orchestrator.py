...
def test_run_diagnosis_calls_all_detectors():
    """Verify run_diagnosis calls all detectors."""
    ...
    with patch('orchestrator.detect_missing') as mock_missing, \
         ...
         patch('orchestrator.detect_patterns') as mock_patterns, \
         patch('orchestrator.detect_ranges') as mock_ranges, \
         patch('orchestrator.detect_near_duplicates') as mock_near_dups, \
         patch('orchestrator.detect_constant_columns') as mock_constant, \
        ...
        mock_near_dups.return_value = []
        mock_constant.return_value = []
        ...
        mock_near_dups.assert_called_once()
